...
const page: FC<pageProps> = ({}) => {
    ...
    async function loginWithGoogle() {
        ...
        try {
            // Using signIn function provided by next-auth
            await signIn("google")
        } catch (error) {
            // Toaster displays a pop-up error message at the top of the screen - see components/Providers.tsx
    ...
    async function loginWithGithub() {
      ...
      try {
        await signIn("github", { redirectUrl: 'http://stackwrite.vercel.app/dashboard' })
      } catch (error) {
        // Toaster displays a pop-up error message at the top of the screen - see components/Providers.tsx
        toast.error("Something went wrong with your login.");
        // Display error message to user
